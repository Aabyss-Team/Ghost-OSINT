...
function sf_viz_dendrogram(targetId, data) {
    ...
    node.append("text")
        ...
        .text(function(d) {
            if (dataMap[d.name][1].length > 20) {
                return GhostOsint.remove_sfurltag(dataMap[d.name][1].substring(0, 20) + "...");
            } else {
                return GhostOsint.remove_sfurltag(dataMap[d.name][1]);
            }
        });
    ...
    function buildPopupMessage(data) {
        ...
        message = "<table>";
        message += "<tr><td><b>类型:</b></td><td>" + data[10] + "</td></tr>";
        message += "<tr><td><b>源模块:</b></td><td>" + data[3] + "</td></tr>";
        message += "<tr><td><b>数据:</b></td><td><pre>" + GhostOsint.remove_sfurltag(data[1])
        message += "</pre></td></tr>";
        message += "</table>";
        return message;
    }
