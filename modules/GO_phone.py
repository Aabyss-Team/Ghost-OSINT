...
#               modules (such as GO_spider) to identify phone numbers, and
...
class GO_phone(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName in ['TARGET_WEB_CONTENT', 'DOMAIN_WHOIS', 'NETBLOCK_WHOIS']:
            ...
            for match in phonenumbers.PhoneNumberMatcher(content, region=None):
                ...
                evt = GhostOsintEvent("PHONE_NUMBER", n, self.__name__, event)
        ...
        if eventName == 'PHONE_NUMBER':
            ...
            evt = GhostOsintEvent("PROVIDER_TELCO", number_carrier, self.__name__, event)
