...
class GO_phishtank(GhostOsintPlugin):
    ...
    def retrieveBlacklist(self):
        blacklist = self.GhostOsint.cacheGet('phishtank', 24)
        ...
        self.GhostOsint.cachePut("phishtank", res['content'])
