...
# -------------------------------------------------------------------------------
# Name:         GO_snov
# Purpose:      ghostosint plugin to search Snov.IO API for emails
...
class GO_snov(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        if self.opts['api_key_client_id'] == "" or self.opts['api_key_client_secret'] == "":
            self.error("You enabled GO_snov but did not set a Client ID and/or Client Secret")
            self.errorState = True
            return
