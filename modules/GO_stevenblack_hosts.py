...
class GO_stevenblack_hosts(GhostOsintPlugin):
    ...
    def retrieveBlocklist(self):
        blocklist = self.GhostOsint.cacheGet('stevenblack_hosts', 24)
        ...
        self.GhostOsint.cachePut("stevenblack_hosts", res['content'])
...
# End of GO_stevenblack_hosts class
