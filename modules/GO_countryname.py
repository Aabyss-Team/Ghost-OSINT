...
#               modules (such as GO_iban, GO_phone, GO_whois) and identifying country names
#
...
class GO_countryname(GhostOsintPlugin):
    ...
    def detectCountryFromPhone(self, srcPhoneNumber):
        ...
        return self.GhostOsint.countryNameFromCountryCode(countryCode.upper())
    ...
    def detectCountryFromDomainName(self, srcDomain):
        ...
        for part in domainParts[::-1]:
            country_name = self.GhostOsint.countryNameFromTld(part)
            if country_name:
                return country_name
    ...
    def detectCountryFromIBAN(self, srcIBAN):
        ...
        return self.GhostOsint.countryNameFromCountryCode(srcIBAN[0:2])
    ...
    def detectCountryFromData(self, srcData):
        ...
        abbvCountryCodes = self.GhostOsint.getCountryCodeDict()
    ...
    def handleEvent(self, event):
        ...
        for countryName in set(countryNames):
            ...
            evt = GhostOsintEvent("COUNTRY_NAME", countryName, self.__name__, event)
            evt.moduleDataSource = moduleDataSource
            self.notifyListeners(evt)

# End of GO_countryname class
