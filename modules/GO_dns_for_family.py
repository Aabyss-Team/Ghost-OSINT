...
class GO_dns_for_family(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        for result in res:
            ...
            evt = GhostOsintEvent(blacklist_type, f"DNS for Family [{eventData}]", self.__name__, event)
            self.notifyListeners(evt)

# End of GO_dns_for_family class
