...
# -------------------------------------------------------------------------------
# Name:         GO_emailformat
# Purpose:      GhostOSINT plug-in for retrieving e-mail addresses
...
class GO_emailformat(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        res = self.GhostOsint.fetchUrl(f"https://www.email-format.com/d/{eventData}/", timeout=self.opts['_fetchtimeout'], useragent=self.opts['_useragent'])
        ...
        emails = self.GhostOsint.parseEmails(data)
        for email in emails:
