# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         GO_openstreetmap
# Purpose:      GhostOSINT plug-in to retrieve latitude/longitude coordinates
...
class GO_openstreetmap(GhostOsintPlugin):
    ...
    def query(self, qry):
        ...
        res = self.GhostOsint.fetchUrl("https://nominatim.openstreetmap.org/search?" + urllib.parse.urlencode(params),
                               timeout=self.opts['_fetchtimeout'], useragent='GhostOSINT')
    ...
    def handleEvent(self, event):
        ...
        for location in data:
            ...
            evt = GhostOsintEvent("PHYSICAL_COORDINATES", coords, self.__name__, event)
            self.notifyListeners(evt)

# End of GO_openstreetmap class
