...
class GO_psbdmp(GhostOsintPlugin):
    ...
    def query(self, qry):
        ...
        res = self.GhostOsint.fetchUrl(url, timeout=15, useragent="GhostOSINT")
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            e = GhostOsintEvent("LEAKSITE_URL", n, self.__name__, event)
            ...
            evt = GhostOsintEvent("LEAKSITE_CONTENT", res['content'], self.__name__, e)
            self.notifyListeners(evt)

# End of GO_psbdmp class
