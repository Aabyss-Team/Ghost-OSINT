...
# -------------------------------------------------------------------------------
# Name:         GO_blockchain
# Purpose:      GhostOSINT plug-in to look up a bitcoin wallet's balance by
...
class GO_blockchain(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        # Wallet balance
        res = self.GhostOsint.fetchUrl("https://blockchain.info/balance?active=" + eventData,
        ...
        evt = GhostOsintEvent("BITCOIN_BALANCE", str(balance) + " BTC", self.__name__, event)
        self.notifyListeners(evt)

# End of GO_blockchain class
