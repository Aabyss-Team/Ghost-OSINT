...
class GO_openbugbounty(GhostOsintPlugin):
    ...
    def queryOBB(self, qry):
        ...
        res = self.GhostOsint.fetchUrl(url, timeout=30, useragent=self.opts['_useragent'])
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            ...
            e = GhostOsintEvent("VULNERABILITY_DISCLOSURE", n, self.__name__, event)
            self.notifyListeners(e)

# End of GO_openbugbounty class
