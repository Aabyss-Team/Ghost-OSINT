...
class GO_reversewhois(GhostOsintPlugin):
    ...
    def query(self, qry):
        ...
        res = self.GhostOsint.fetchUrl(url, timeout=self.opts.get("_fetchtimeout", 30))
    ...
    def handleEvent(self, event):
        ...
        for registrar in registrars:
            e = GhostOsintEvent("DOMAIN_REGISTRAR", registrar, self.__name__, event)
            self.notifyListeners(e)

# End of GO_reversewhois class
