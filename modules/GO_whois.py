...
# -------------------------------------------------------------------------------
# Name:         GO_whois
# Purpose:      GhostOSINT plug-in for searching Whois servers for domain names
...
class GO_whois(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        rawevt = GhostOsintEvent(typ, data, self.__name__, event)
        ...
        if eventName.startswith("DOMAIN_NAME"):
            if whoisdata:
                ...
                if registrar:
                    evt = GhostOsintEvent("DOMAIN_REGISTRAR", registrar, self.__name__, event)
                    self.notifyListeners(evt)

# End of GO_whois class
