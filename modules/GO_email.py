...
#               modules (such as GO_spider) and identifying e-mail addresses
#
...
class GO_email(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        emails = self.GhostOsint.parseEmails(eventData)
        for email in set(emails):
            ...
            if not self.GhostOsint.validHost(mailDom, self.opts['_internettlds']):
            ...
            evt = GhostOsintEvent(evttype, mail, self.__name__, event)
