...
class GO_gleif(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName == "LEI":
            ...
            for record in res:
                ...
                lei = data.get('id')
                if not GhostOsintHelp.validLEI(lei):
                    continue
        ...
        for lei in set(leis):
            ...
            e = GhostOsintEvent("LEI", lei, self.__name__, event)
            self.notifyListeners(e)
            ...
            if legal_name:
                ...
                if entity_name:
                    e = GhostOsintEvent("COMPANY_NAME", entity_name, self.__name__, event)
                    self.notifyListeners(e)
            ...
            for address in set(addresses):
                e = GhostOsintEvent("PHYSICAL_ADDRESS", address, self.__name__, event)
                self.notifyListeners(e)

# End of GO_gleif class
