...
class GO_slideshare(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        e = GhostOsintEvent("RAW_RIR_DATA", f"Possible full name: {human_name[0]}", self.__name__, event)
        ...
        e = GhostOsintEvent("GEOINFO", location[0], self.__name__, event)
        self.notifyListeners(e)

# End of GO_slideshare class
