# -*- coding: utf-8 -*-
# -----------------------------------------------------------------------------
# Name:         GO_dnscommonsrv
# Purpose:      GhostOSINT plug-in for attempting to resolve through
...
class GO_dnscommonsrv(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        if srcModuleName == "GO_dnscommonsrv":
        ...
        for srv in self.commonsrv:
            ...
            if self.GhostOsint.hashstring(name) in self.events:
                continue
