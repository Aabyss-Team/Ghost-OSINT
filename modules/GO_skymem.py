...
# -------------------------------------------------------------------------------
# Name:         GO_skymem
# Purpose:      GhostOSINT plug-in for retrieving up to 100 e-mail addresses
...
class GO_skymem(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        res = self.GhostOsint.fetchUrl("http://www.skymem.info/srch?q=" + eventData, timeout=self.opts['_fetchtimeout'], useragent=self.opts['_useragent'])
        ...
        for page in range(1, 21):
            res = self.GhostOsint.fetchUrl("http://www.skymem.info/domain/" + domain_id + "?p=" + str(page), timeout=self.opts['_fetchtimeout'], useragent=self.opts['_useragent'])
