...
class GO_darksearch(GhostOsintPlugin):
    ...
    def query(self, qry, page):
        ...
        res = self.GhostOsint.fetchUrl("https://darksearch.io/api/search?" + urllib.parse.urlencode(params),
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                if self.opts['fetchlinks']:
                    ...
                    evt = GhostOsintEvent("DARKNET_MENTION_CONTENT",
                                          "..." + data + "...",
                                          self.__name__,
                                          event)
                    self.notifyListeners(evt)
            ...
            if found:
                evt = GhostOsintEvent("RAW_RIR_DATA", str(query_results), self.__name__, event)
                self.notifyListeners(evt)

# End of GO_darksearch class
