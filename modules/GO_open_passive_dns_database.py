# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:        GO_open_passive_dns_database
    ...
    def handleEvent(self, event):
        ...
        for record in data:
            ...
            if answer_type == 'A':
                ...
                if self.opts['verify'] and not self.GhostOsint.validateIP(query, answer):
            ...
            if answer_type == 'AAAA':
                ...
                if not self.GhostOsint.validIP6(answer):
...
# End of GO_open_passive_dns_database class
