# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         GO_strangeheaders
# Purpose:      GhostOSINT plug-in for identifying non-standard HTTP headers
...
class GO_strangeheaders(GhostOsintPlugin):
    ...
    def handleEvent(self, event):
        ...
        for key in data:
            if key.lower() not in headers:
                evt = GhostOsintEvent("WEBSERVER_STRANGEHEADER", f"{key}: {data[key]}", self.__name__, event)
                self.notifyListeners(evt)

# End of GO_strangeheaders class
