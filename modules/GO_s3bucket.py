...
# -------------------------------------------------------------------------------
# Name:         GO_s3bucket
# Purpose:      GhostOSINT plug-in for identifying potential S3 buckets related to
#               the target.
#
...
class GO_s3bucket(GhostOsintPlugin):
    ...
    def threadSites(self, siteList):
        ...
        for site in siteList:
            ...
            t.append(threading.Thread(name='thread_GO_s3buckets_' + tname,
        ...
        while running:
            ...
            for rt in threading.enumerate():
                if rt.name.startswith("thread_GO_s3buckets_"):
                    found = True
