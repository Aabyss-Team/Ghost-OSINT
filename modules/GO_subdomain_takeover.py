...
class GO_subdomain_takeover(GhostOsintPlugin):
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        content = self.GhostOsint.cacheGet("subjack-fingerprints", 48)
        if content is None:
            url = "https://raw.githubusercontent.com/haccer/subjack/master/fingerprints.json"
            res = self.GhostOsint.fetchUrl(url, useragent="GhostOSINT")
            ...
            self.GhostOsint.cachePut("subjack-fingerprints", res['content'])
            content = res['content']
                    ...
                    for proto in ["https", "http"]:
                        ...
                        for fingerprint in fingerprints:
                            if fingerprint in res['content']:
                                ...
                                evt = GhostOsintEvent("AFFILIATE_INTERNET_NAME_HIJACKABLE", eventData, self.__name__, event)
...
# End of GO_subdomain_takeover class
